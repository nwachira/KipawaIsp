					...
					<div class="form-group">
                        ...
                        <div class="col-md-6">
                          <select class="form-control" name="bankname" id="bankstk">
                            ...
                            <option value="Family Bank" {if $_c['Stkbankname'] == 'Family Bank Ltd'}selected{/if}>Family Bank Ltd</option>
                            
                            
                            
                            <option value="Barclays Bank K LTD" {if $_c['Stkbankname'] == 'Barclays Bank K LTD'}selected{/if}>Barclays Bank K LTD</option>
