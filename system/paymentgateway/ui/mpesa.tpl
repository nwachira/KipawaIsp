                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    {if $_c['mpesa_shortcode_type'] == "BuyGoods"}
                        <div class="form-group row" id="tillNumberContainer">
                    ...
                    {else}
                        <div class="form-group row" id="tillNumberContainer" style="display: none;">
                    ...
                    <div id="offlinePayFields" style="display: none;">
                        ...
                        {if $_c['mpesa_channel_ofline_online'] == 1}
                            <div class="form-group row col-12 styled-form-group row">
