...
<script src="ui/ui/styles/js/bootstrap.bundle.min.js"></script>
    <script src="ui/ui/styles/js/Chart.min.js"></script>
    <script src="ui/ui/styles/js/dynamic-pie-chart.js"></script>
    <script src="ui/ui/styles/js/moment.min.js"></script>
    <script src="ui/ui/styles/js/fullcalendar.js"></script>
    <script src="ui/ui/styles/js/jvectormap.min.js"></script>
    <script src="ui/ui/styles/js/world-merc.js"></script>
    <script src="ui/ui/styles/js/polyfill.js"></script>
    <script src="ui/ui/styles/js/main.js"></script>
