...
<body class="hold-transition modern-skin-dark sidebar-mini {if $_kolaps}sidebar-collapse{/if}">
    ...
    <section class="sidebar">
        <ul class="sidebar-menu" data-widget="tree">
            <!-- Dashboard -->
            <li class="{if $_system_menu eq 'dashboard'}active{/if}">
            ...
            <li class="treeview {if in_array($_system_menu, ['customers', 'map'])}active{/if}">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    <li class="{if $_system_menu eq 'customers'}active{/if}">
                        <a href="{$_url}customers">
                            <i class="far fa-circle"></i> {Lang::T('Lists')}
                        </a>
                    </li>
                    <li class="{if $_system_menu eq 'map'}active{/if}">
                        <a href="{$_url}map/customer">
                            <i class="far fa-circle"></i> {Lang::T('Location')}
                        </a>
                    </li>
                    {$_MENU_CUSTOMERS}
                </ul>
            ...
            <!-- Services -->
            <li class="treeview {if $_routes[0] eq 'plan' || $_routes[0] eq 'coupons'}active{/if}">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    <li class="{if $_routes[1] eq 'list'}active{/if}">
                        <a href="{$_url}plan/list">
                            <i class="far fa-circle"></i> {Lang::T('Active Customers')}
                        </a>
                    </li>
                    {if $_c['disable_voucher'] != 'yes'}
                    <li class="{if $_routes[1] eq 'refill'}active{/if}">
                        <a href="{$_url}plan/refill">
                            <i class="far fa-circle"></i> {Lang::T('Refill Customer')}
                        </a>
                    </li>
                    {/if}
                    {$_MENU_SERVICES}
            ...
            <li class="treeview {if $_system_menu eq 'services'}active{/if}">
                <a href="#">
                    <i class="fas fa-wifi"></i>
                    <span>{Lang::T('Internet Plan')}</span>
                    <i class="fas fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <li class="{if $_routes[1] eq 'hotspot'}active{/if}">
                        <a href="{$_url}services/hotspot">
                            <i class="far fa-circle"></i> Hotspot
                        </a>
                    </li>
                    <li class="{if $_routes[1] eq 'pppoe'}active{/if}">
            ...
            <!-- Reports -->
            <li class="treeview {if $_system_menu eq 'reports'}active{/if}">
                ...
                {/if}
                <ul class="treeview-menu">
                    <li class="{if $_routes[1] eq 'reports'}active{/if}">
                        <a href="{$_url}reports">
                            <i class="far fa-circle"></i> {Lang::T('Daily Reports')}
                        </a>
                    </li>
                    <li class="{if $_routes[1] eq 'activation'}active{/if}">
                        <a href="{$_url}reports/activation">
                            <i class="far fa-circle"></i> {Lang::T('Activation History')}
                        </a>
                    </li>
                    {$_MENU_REPORTS}
                </ul>
...
{if $_c['radius_enable']}
    <li class="{if $_system_menu eq 'radius' && $_routes[0] eq 'radius'}treeview active-hover{/if}">
        <a href="#">
        ...
        <ul class="treeview-menu">
            <li {if $_routes[0] eq 'radius' and $_routes[1] eq 'nas-list' }class="hover-item" {/if}>
                <a href="{$_url}radius/nas-list">
                    <i class="far fa-circle"></i> {Lang::T('Radius NAS')}
                </a>
            </li>
            {$_MENU_RADIUS}
        </ul>
...
<li class="{if $_system_menu eq 'settings' || $_system_menu eq 'paymentgateway' || $_system_menu eq 'radius'}active{/if} treeview">
    <a href="#">
        ...
        {if in_array($_admin['user_type'],['SuperAdmin','Admin','Agent'])}
            <li {if $_routes[1] eq 'users' }class="active" {/if}>
                <a href="{$_url}settings/users">
                    <i class="far fa-circle"></i> {Lang::T('Administrator Users')}
                </a>
            </li>
        {/if}
        {if in_array($_admin['user_type'],['SuperAdmin','Admin'])}
            <li {if $_routes[1] eq 'dbstatus' }class="active" {/if}>
                <a href="{$_url}settings/dbstatus">
                    <i class="far fa-circle"></i> {Lang::T('Backup/Restore')}
                </a>
            </li>
            <li {if $_system_menu eq 'paymentgateway' }class="active" {/if}>
                <a href="{$_url}paymentgateway">
                    <i class="far fa-circle"></i> <span class="text">{Lang::T('Payment Gateway')}</span>
                </a>
            </li>
