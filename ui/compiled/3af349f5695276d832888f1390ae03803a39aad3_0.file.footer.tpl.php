...
/* Smarty version 4.5.3, created on 2025-01-17 12:29:01
  from '/home/wachira/Kipawa/ui/ui/sections/footer.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_678a22ddde7ea5_67424547',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3af349f5695276d832888f1390ae03803a39aad3' => 
    array (
      0 => '/home/wachira/Kipawa/ui/ui/sections/footer.tpl',
      1 => 1736415258,
      2 => 'file',
    ),
  ),
...
function content_678a22ddde7ea5_67424547 (Smarty_Internal_Template $_smarty_tpl) {
?></section>
</div>
...
community#latestVersion';"></div>
    Kipawa by <a href="https://github.com/hotspotbilling/phpnuxbill" rel="nofollow noreferrer noopener"
        target="_blank">Unganisha Networks</a>, Theme by <a href="https://adminlte.io/" rel="nofollow noreferrer noopener"
...
<?php echo '<script'; ?>
 src="ui/ui/styles/js/bootstrap.bundle.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="ui/ui/styles/js/Chart.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="ui/ui/styles/js/dynamic-pie-chart.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="ui/ui/styles/js/moment.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="ui/ui/styles/js/fullcalendar.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="ui/ui/styles/js/jvectormap.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="ui/ui/styles/js/world-merc.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="ui/ui/styles/js/polyfill.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="ui/ui/styles/js/main.js"><?php echo '</script'; ?>
>
